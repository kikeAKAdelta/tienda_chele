...
public class frmApertura extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Apertura/Cierre");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 20, 140, -1));
        ...
        jLabel1.setText("Ingrese el valor con que inicia el día:");
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 20, 230, 40));
        ...
        jPanel2.add(txtApertura, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 90, 240, 30));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel3.setText("Apertura $");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 90, 70, 30));
    ...
    private void btnTerminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTerminarActionPerformed
        if(txtApertura.getText().equals("")){
            mensajeNotificacion("¡Ingrese Apertura!", "Error");
        }else{
            try {
    ...
    private void txtAperturaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtAperturaKeyTyped
        ...
        if ((c >=48 && c<=57)  || (c==46) || (c==8) || (c== (char)KeyEvent.VK_BACK_SPACE) || (c== (char)KeyEvent.VK_ENTER)) {
            if (c==46) {
                String cadena=txtApertura.getText();
