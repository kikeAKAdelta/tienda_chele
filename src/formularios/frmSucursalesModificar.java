...
import static formularios.frmSucursales.lblUser;
import static formularios.frmSucursales.lblUser1;
...
public class frmSucursalesModificar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblAgregarSucursales.setForeground(new java.awt.Color(153, 153, 153));
        lblAgregarSucursales.setText("Agregar Sucursales");
        lblAgregarSucursales.setToolTipText("Agregar una nueva sucursal.");
        lblAgregarSucursales.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
    ...
    private void lblListaSucursalesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblListaSucursalesMouseClicked
        frmSucursales lp = new frmSucursales();
        lp.setVisible(true);
        this.setVisible(false);
