...
import static formulariosReportes.frmReporteInventarios.lblUser;
import static formulariosReportes.frmReporteInventarios.lblUser1;
...
public class frmReporteVentas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tipo.add(rbtnVF);
        rbtnVF.setFont(new java.awt.Font("Segoe UI Light", 1, 12)); // NOI18N
        rbtnVF.setForeground(new java.awt.Color(102, 0, 0));
        rbtnVF.setSelected(true);
        rbtnVF.setText("VENTAS FACTURA");
        getContentPane().add(rbtnVF, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 320, -1, -1));

        tipo.add(rbtnVC);
        rbtnVC.setFont(new java.awt.Font("Segoe UI Light", 1, 12)); // NOI18N
        rbtnVC.setForeground(new java.awt.Color(102, 0, 0));
        ...
        lblReporteVenta.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    ...
    private void lblReporteCompraMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblReporteCompraMouseClicked
        frmComprasReportes rv = new frmComprasReportes();
        rv.setVisible(true);
